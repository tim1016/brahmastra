<div class="wrap">
    ...
    <?php settings_errors( );
        // if(isset($_POST['edit_post'])) echo $_POST['edit_post'];
    ?>
    ...
    <div class="tab-content">
        <div id="tab-1" class="tab-pane <?php echo (!isset($_POST['edit_post']))? 'active': ''  ?>">
			...
			<?php 
                // $options = (get_option('alecaddd_plugin_cpt'))? get_option('alecaddd_plugin_cpt'): array() ;
                // The statement below is same as the statement above, however get_options is only called once, which is great
				...
				foreach ($options as $option) {
                    ...
                    submit_button('Delete',  'delete small', 'delete', false, array(
                        'onclick' => 'return confirm("Are you sure to delete this post-type? The data associated with this post-type will remain in your database.")'
                    ));
                    echo '</form>';
