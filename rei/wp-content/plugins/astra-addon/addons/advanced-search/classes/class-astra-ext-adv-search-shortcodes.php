	...
	class Astra_Ext_Adv_Search_Shortcodes {
		...
		function search_markup( $atts ) {
			...
			if ( 'inline' === $atts['style'] ) {
				...
				$markup = '<div class="ast-search-icon"><a class="full-screen astra-search-icon" href="#"></a></div>';
				add_action(
					'wp_footer', function() {
				...
				$markup  = '<div class="ast-search-icon"><a class="header-cover astra-search-icon" href="#"></a></div>';
