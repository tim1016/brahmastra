...
function astra_ext_above_header_sections_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {
	 ...
	 * Above Header.
	 */
	$desktop_sticky_above_header_bg_color = astar( astra_get_option( 'sticky-above-header-bg-color-responsive' ), 'desktop', '#ffffff' );
	$tablet_sticky_above_header_bg_color  = astar( astra_get_option( 'sticky-above-header-bg-color-responsive' ), 'tablet' );
	$mobile_sticky_above_header_bg_color  = astar( astra_get_option( 'sticky-above-header-bg-color-responsive' ), 'mobile' );
	...
	if ( 'none' === $sticky_header_style && ! $sticky_hide_on_scroll ) {
		$desktop_above_header_css_output = array(
			'.ast-above-sticky-header-active .ast-above-header' => array(
...
function astra_ext_below_header_sections_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {
	 ...
	 * Below Header.
	 */
	$desktop_sticky_below_header_bg_color = astar( astra_get_option( 'sticky-below-header-bg-color-responsive' ), 'desktop', '#414042' );
	$tablet_sticky_below_header_bg_color  = astar( astra_get_option( 'sticky-below-header-bg-color-responsive' ), 'tablet' );
	$mobile_sticky_below_header_bg_color  = astar( astra_get_option( 'sticky-below-header-bg-color-responsive' ), 'mobile' );
	...
	if ( 'none' === $sticky_header_style && ! $sticky_hide_on_scroll ) {
		$desktop_below_header_css_output = array(
			'.ast-below-sticky-header-active .ast-below-header' => array(
